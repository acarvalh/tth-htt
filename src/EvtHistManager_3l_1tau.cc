...
void EvtHistManager_3l_1tau::bookHistograms(TFileDirectory& dir)
{
  ...
  histogram_mvaOutput_noHTT_SUM_T_ = book1D(dir, "mvaOutput_noHTT_SUM_T","mvaOutput_noHTT_SUM_T", 100, 0., 1.);
  ...
  histogram_mvaOutput_noHTT_1B_T_ = book1D(dir, "mvaOutput_noHTT_1B_T", "mvaOutput_noHTT_1B_T", 100, 0., 1.);
  histogram_mvaOutput_noHTT_1B_VT_ = book1D(dir, "mvaOutput_noHTT_1B_VT", "mvaOutput_noHTT_1B_VT", 100, 0., 1.);
}
